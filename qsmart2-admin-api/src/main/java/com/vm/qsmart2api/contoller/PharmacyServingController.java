 ...
 */
@RestController
@RequestMapping("pharmacy-serving/")
//@RequestMapping("${pharmacy.serving.path}/")
public class PharmacyServingController {

    private final Logger logger = LogManager.getLogger(PharmacyServingController.class);
    ...
    @Autowired
    PharmacyTokenServingService pharmacyServingService;
    ...
    public ResponseEntity<TokensInfoResponse> getTokensInfo(
        ...
        try {
            ...
            TokensInfoResponse tokens = pharmacyServingService.getTokensInfoByServiceId(header, userId, serviceId);
    ...
    public ResponseEntity<CustomResponse> tokenAction(Locale locale,
        ...
        try {
            ...
            return pharmacyServingService.performActionOnTOken(header, servintToken, userId, locale, actionType);
        } catch (Exception e) {
