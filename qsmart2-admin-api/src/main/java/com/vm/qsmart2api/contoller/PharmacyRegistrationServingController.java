...
import com.vm.qsmart2api.service.PharmacyRegistrationTokenServingService;
 ...
 */
@RestController
@RequestMapping("pharmacyregistration-serving/")
public class PharmacyRegistrationServingController {

    private final Logger logger = LogManager.getLogger(PharmacyRegistrationServingController.class);
    ...
    @Autowired
    PharmacyRegistrationTokenServingService pharmRegistrationTokenServingService;
    ...
    public ResponseEntity<TokensInfoResponse> getTokensInfoByBranchId(
        ...
        try {
            ...
            TokensInfoResponse tokens = pharmRegistrationTokenServingService.getTokensInfoByBranchId(header, userId, branchId);
    ...
    public ResponseEntity<CustomResponse> tokenAction(Locale locale,
        ...
        try {
            ...
            return pharmRegistrationTokenServingService.performActionOnTOken(header, servintToken, userId, locale, actionType);
        } catch (Exception e) {
