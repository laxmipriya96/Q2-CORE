...
import com.vm.qsmart2api.service.RadiologyTokenServingService;
 ...
 */
@RestController
@RequestMapping("radiology-serving/")
public class RadiologyServingController {
    private final Logger logger = LogManager.getLogger(RadiologyServingController.class);
    ...
    @Autowired
    RadiologyTokenServingService radiologyServingService;
    ...
    public ResponseEntity<TokensInfoResponse> getTokensInfo(
        ...
        try {
            ...
            TokensInfoResponse tokens = radiologyServingService.getTokensInfoByServiceId(header, userId, serviceId);
    ...
    public ResponseEntity<CustomResponse> tokenAction(Locale locale,
        ...
        try {
            ...
            return radiologyServingService.performActionOnTOken(header, servintToken, userId, locale, actionType);
        } catch (Exception e) {
