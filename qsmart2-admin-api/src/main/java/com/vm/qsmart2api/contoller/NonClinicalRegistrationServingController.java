...
import com.vm.qsmart2api.service.NonClinicalRegistrationTokenServingService;
 ...
 */
@RestController
@RequestMapping("non-clinical-registration-serving/")
public class NonClinicalRegistrationServingController {
    private final Logger logger = LogManager.getLogger(NonClinicalRegistrationServingController.class);
    ...
    @Autowired
    NonClinicalRegistrationTokenServingService nonClinicalRegistrationTokenService;
    ...
    public ResponseEntity<TokensInfoResponse> getTokensInfoByBranchId(
        ...
        try {
            ...
            TokensInfoResponse tokens = nonClinicalRegistrationTokenService.getTokensInfoByBranchId(header, userId, branchId);
    ...
    public ResponseEntity<CustomResponse> tokenAction(Locale locale,
        ...
        try {
            ...
            return nonClinicalRegistrationTokenService.performActionOnTOken(header, servintToken, userId, locale, actionType);
        } catch (Exception e) {
