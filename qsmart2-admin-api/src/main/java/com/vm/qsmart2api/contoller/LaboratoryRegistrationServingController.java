...
import com.vm.qsmart2api.service.LaboratoryRegistrationTokenServingService;
 ...
 */
@RestController
@RequestMapping("laboratoryregistration-serving/")
public class LaboratoryRegistrationServingController {

    private final Logger logger = LogManager.getLogger(LaboratoryRegistrationServingController.class);
    ...
    @Autowired
    LaboratoryRegistrationTokenServingService laboratoryRegistrationServingService;
    ...
    public ResponseEntity<TokensInfoResponse> getTokensInfoByBranchId(
        ...
        try {
            ...
            TokensInfoResponse tokens = laboratoryRegistrationServingService.getTokensInfoByBranchId(header, userId, branchId);
    ...
    public ResponseEntity<CustomResponse> tokenAction(Locale locale,
        ...
        try {
            ...
            return laboratoryRegistrationServingService.performActionOnTOken(header, servintToken, userId, locale, actionType);
        } catch (Exception e) {
