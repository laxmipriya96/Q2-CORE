...
import com.vm.qsmart2api.service.RadiologRegistarionTokenServingService;
 ...
 */
@RestController
@RequestMapping("radiologyregistration-serving/")
public class RadiologyRegistrationServingController {

    private final Logger logger = LogManager.getLogger(RadiologyRegistrationServingController.class);
    ...
    @Autowired
    RadiologRegistarionTokenServingService radiologRegServingService;
    ...
    public ResponseEntity<TokensInfoResponse> getTokensInfoByBranchId(
        ...
        try {
            ...
            TokensInfoResponse tokens = radiologRegServingService.getTokensInfoByBranchId(header, userId, branchId);
    ...
    public ResponseEntity<CustomResponse> tokenAction(Locale locale,
        ...
        try {
            ...
            return radiologRegServingService.performActionOnTOken(header, servintToken, userId, locale, actionType);
        } catch (Exception e) {
