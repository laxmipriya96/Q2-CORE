...
import com.vm.qsmart2api.service.LaboratoryTokenServingService;
 ...
 */
@RestController
@RequestMapping("laboratory-serving/")
public class LaboratoryServingController {
    private final Logger logger = LogManager.getLogger(LaboratoryServingController .class);
    ...
    @Autowired
    LaboratoryTokenServingService laboratoryServingService;
    ...
    public ResponseEntity<TokensInfoResponse> getTokensInfo(
        ...
        try {
            ...
            TokensInfoResponse tokens = laboratoryServingService.getTokensInfoByServiceId(header, userId, serviceId);
    ...
    public ResponseEntity<CustomResponse> tokenAction(Locale locale,
        ...
        try {
            ...
            return laboratoryServingService.performActionOnTOken(header, servintToken, userId, locale, actionType);
        } catch (Exception e) {
